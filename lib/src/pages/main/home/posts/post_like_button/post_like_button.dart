...
class OptimisticPostLikeButton extends StatefulWidget {
  const OptimisticPostLikeButton({
    Key? key,
  ...
  @override
  State<OptimisticPostLikeButton> createState() =>
      _OptimisticPostLikeButtonState();
}

class _OptimisticPostLikeButtonState extends State<OptimisticPostLikeButton> {
